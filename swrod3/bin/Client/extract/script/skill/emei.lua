...
SKILLS={
	...
	fofa_wubian={ --·ð·¨ÎÞ±ß
		...
		anti_block_rate={{{1,1},{30,30},{31,30}},{{1,-1},{2,-1}}},--²ð½â¸ñµ²
		lifemax_yan_p={{{1,21},{35,50},{36,50}},{{1,-1},{30,-1}}},
		returnres_p={{{1,1},{20,20},{31,20}},{{1,-1},{2,-1}}},--·´µ¯¿¹ÐÔ
		anti_do_hurt_p={{{1,1},{9,1},{10,10},{39,10},{40,15},{41,15}},{{1,-1},{2,-1}}},
	},
	foxin_ciyou={ --·ðÐÄ´ÈÓÓ
	...
	jianemei150_2={ --½£¶ëÃ¼150µÚ2Ê½
		physicsenhance_p={{{1,12},{2,24},{50,600},{51,600}}},
	...
	zhangemei150={ --ÕÆ¶ëÃ¼150	±ùÓêçó¾§
		seriesdamage_p={{{1,40},{15,40},{20,80},{21,82}}},
		colddamage_v={
			[1]={{1,150},{20,3000},{30,4500},{40,6000},{50,7500},{51,7500}}, --Ã¿¼¶Ôö¼Ó±ùÉË150µã 20160801
   			[3]={{1,150},{20,3000},{30,4500},{40,6000},{50,7500},{51,7500}},
	...
	zhangemei150_2={ --ÕÆ¶ëÃ¼150µÚ2Ê½
		colddamage_v={
			[1]={{1,100},{50,5000},{51,5000}},
			[3]={{1,100},{50,5000},{51,5000}},
		},
		seriesdamage_p={{{1,20},{20,60},{21,62}}},
		missle_speed_v={{{1,24},{20,28},{21,28}}},
		skill_misslenum_v={{{1,1},{10,1},{20,3},{21,3}}},
