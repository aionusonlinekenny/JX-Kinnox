...
SKILLS={
	...
	zuidie_kuangwu={ --×íµú¿ñÎè
		...
		anti_do_hurt_p={{{1,0},{9,0},{10,10},{19,10},{20,20},{29,20},{30,30},{39,30},{40,40},{49,40}},{{1,18*120},{30,18*180}}},
...
--		},
	...
	zhanggaibang150={ --ÕÆØ¤°ï150
		...
		firedamage_v={
			[1]={{1,225},{30,6750},{50,11250},{51,11250}},
			[3]={{1,225},{30,6750},{50,11250},{51,11250}},
		},
		...
		skill_eventskilllevel={{{1,1},{20,20}}},
		fatallystrike_p={{{1,1},{9,1},{10,10},{21,10}}},
--		skill_flyevent={
--			[1]={{1,0},{10,0},{10,1},{20,1}},
--			[2]={{1,4},{2,4}},
--			[3]={{1,389},{20,389}}
