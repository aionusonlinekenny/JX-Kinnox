...
SKILLS={
	...
	huolian_fenhua={ --»ðÁ«·Ù»ª
		...
		function(level)
			return 
			"Thêi gian kh«i phôc chiªu thøc: <color=orange>"..floor(Link(level,SKILLS.huolian_fenhua.skill_mintimepercast_v[1]) / 18).." gi©y<color>\n"
		end,
	},
	huanying_feihu={ --»ÃÓ°·Éºü
		...
		function(level)
			return 
			"Thêi gian kh«i phôc chiªu thøc: <color=orange>"..floor(Link(level,SKILLS.huanying_feihu.skill_mintimepercast_v[1]) / 18).." gi©y<color>\n"
		end,
	},
	...
	feihong_wuji={ --·ÉºèÎÞ¼£
		...
		function(level)
			return 
			"Thêi gian kh«i phôc chiªu thøc: <color=orange>"..floor(Link(level,SKILLS.feihong_wuji.skill_mintimepercast_v[1]) / 18).." gi©y<color>\n"
		end,
	...
	limo_duopo={ --À÷Ä§¶áÆÇ
		...
		function(level)
			return 
			"Thêi gian kh«i phôc chiªu thøc: <color=orange>"..floor(Link(level,SKILLS.limo_duopo.skill_mintimepercast_v[1]) / 18).." gi©y<color>\n"
		end,
...
--		lifemax_p={{{1,-11},{20,-30},{30,-20},{40,10},{41,10}},{{1,18*45},{30,18*180}}},
		...
		attackspeed_yan_v={{{1,0},{38,0},{39,60},{40,60}},{{1,18*120},{30,18*360}}},--Ôö¼ÓÍâ¹¦ÏµÎä¹¦³öÕÐ¶¯×÷£¨Ñô£©
		...
		castspeed_yan_v={{{1,0},{40,0},{41,32},{42,32}},{{1,-1},{30,-1}}},
		fastwalkrun_p={{{1,1},{9,1},{10,10},{19,10},{20,20},{29,20},{30,30},{39,30},{40,40},{41,40}},{{1,-1},{30,-1}}},
	},
	beisu_qingfeng={ --±¯ËÖÇå·ç
		...
		function(level)
			return 
			"Thêi gian kh«i phôc chiªu thøc: <color=orange>"..floor(Link(level,SKILLS.beisu_qingfeng.skill_mintimepercast_v[1]) / 18).." gi©y<color>\n"
		end,
	},
	yunlong_ji={ --ÔÆÁú»÷
...
--		skill_showevent={{{1,0},{10,0},{10,1},{20,1}}},
	...
	moren150={ --Ä§ÈÌ150	¼²»ðÁÇÔ­
		...
		--¼õÉÙÖÂÃüÒ»»÷ÂÊ£¬Ôö¼Ó»ð¹¥ÉËº¦
		firedamage_v={
			[1]={{1,240},{30,7200},{50,12000},{51,12000}},
			[3]={{1,240},{30,7200},{50,12000},{51,12000}}
		},
		--fatallystrike_p={{{1,10},{20,25}}},
		missle_speed_v={{{1,0},{20,0}}},
		skill_attackradius={{{1,448},{20,512}}},		--¼¼ÄÜ·¶Î§´Ó480µ÷Õûµ½512 20160801
...
--	},
	shehun_luanxin={ --Éã»êÂÒÐÄ
		...
		function(level)
			return 
			"Thêi gian kh«i phôc chiªu thøc: <color=orange>"..floor(Link(level,SKILLS.shehun_luanxin.skill_mintimepercast_v[1]) / 18).." gi©y<color>\n"
		end,
	},
