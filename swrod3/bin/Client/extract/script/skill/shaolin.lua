...
SKILLS={
	...
	luohan_zhen={ --ÂÞººÕó
		...
		meleedamagereturn_p={{{1,5},{9,5},{10,10},{19,10},{20,15},{29,15},{30,20},{40,20},{41,20}},{{1,18},{2,18}}},
		rangedamagereturn_p={{{1,5},{9,5},{10,10},{19,10},{20,15},{29,15},{30,20},{40,20},{41,20}},{{1,18},{2,18}}},
	...
	yijin_jing={ --Ò×½î¾­
		...
		meleedamagereturn_p={{{1,5},{19,5},{20,10},{29,10},{30,15},{40,15}},{{1,-1},{2,-1}}},	--¼õÉÙ½üÕ½ºÍÔ¶³ÌµÄ¹¥»÷·´µ¯£¬´Ó25%¼õÉÙµ½15% 20160919
		rangedamagereturn_p={{{1,5},{19,5},{20,10},{29,10},{30,15},{40,15}},{{1,-1},{2,-1}}},
		...
		castspeed_yan_v={{{1,0},{29,0},{30,30},{31,30}},{{1,-1},{30,-1}}},
	},
	rulai_qianye={ --ÈçÀ´Ç§Ò¶
		...
		anti_do_hurt_p={{{1,0},{19,0},{20,5},{29,5},{30,10},{44,10},{45,15},{50,15}},{{1,-1},{2,-1}}},
	},
	damo_dujiang={ --´ïÄ¦¶É½­
	...
	quanshaolin150={ --È­ÉÙÁÖ150
		...
		stun_p={{{1,1.5},{20,20},{35,35},{36,35}},{{1,5},{20,5},{21,6}}},	--Ã¿¼¶Ôö¼Ó0.5%Ñ£ÔÎ¼¸ÂÊ 20160801
	...
	gunshaolin150={ --¹÷ÉÙÁÖ150	--Î¤ÍÓÏ×èÆ
		...
		ignoredefense_p={{{1,9},{20,99},{24,99},}},
		colddamage_v={
	...
	daoshaolin150={ --µ¶ÉÙÁÖ150
		physicsenhance_p={{{1,40},{20,800},{50,2000},{51,2000}}},
		seriesdamage_p={{{1,40},{15,40},{20,80},{21,82}}},
		colddamage_v={
		...
		missle_speed_v={{{1,48},{20,48},{23,48},{30,48}}},
		missle_lifetime_v={{{1,10},{20,10},{23,10},{30,10}}},
		skill_attackradius={{{1,448},{20,512}}},
		skill_skillexp_v={{	{1,300},
												{2,600},
												{3,1000},
