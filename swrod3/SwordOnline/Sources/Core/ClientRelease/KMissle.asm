...
;	COMDAT xdata$x
xdata$x	SEGMENT
$T92802	DD	019930520H
	DD	01H
	DD	FLAT:$T92805
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	ORG $+4
$T92805	DD	0ffffffffH
	DD	FLAT:$L92797
xdata$x	ENDS
;	COMDAT ??1KMissleSet@@QAE@XZ
_TEXT	SEGMENT
...
;	COMDAT xdata$x
xdata$x	SEGMENT
$T92849	DD	019930520H
	DD	01H
	DD	FLAT:$T92851
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	ORG $+4
$T92851	DD	0ffffffffH
	DD	FLAT:$L92836
xdata$x	ENDS
;	COMDAT ??0KMissle@@QAE@XZ
_TEXT	SEGMENT
...
; File ..\engine\src\KNode.h
xdata$x	SEGMENT
$T92893	DD	019930520H
	DD	01H
	DD	FLAT:$T92895
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	ORG $+4
$T92895	DD	0ffffffffH
	DD	FLAT:$L92882
xdata$x	ENDS
;	COMDAT ??1KMissle@@UAE@XZ
_TEXT	SEGMENT
...
; 380  : 			SubWorld[0].Map2Mps(m_nRegionId, m_nCurrentMapX, m_nCurrentMapY,m_nXOffset, m_nYOffset, &nSrcX2, &nSrcY2);
	...
	lea	edx, DWORD PTR _nSrcY2$92026[esp+12]
	lea	eax, DWORD PTR _nSrcX2$92025[esp+12]
	push	edx
	...
	mov	DWORD PTR _nSrcX2$92025[esp+40], 0
	mov	DWORD PTR _nSrcY2$92026[esp+40], 0
	call	?Map2Mps@KSubWorld@@QAEXHHHHHPAH0@Z	; KSubWorld::Map2Mps

; 381  : 			m_MissleRes.PlaySound(MS_DoFly, nSrcX2, nSrcY2, 0);

	mov	eax, DWORD PTR _nSrcY2$92026[esp+12]
	mov	ecx, DWORD PTR _nSrcX2$92025[esp+12]
	push	0
	push	eax
	push	ecx
	push	1
...
; 435  : 		SubWorld[0].Map2Mps(m_nRegionId, m_nCurrentMapX, m_nCurrentMapY,m_nXOffset, m_nYOffset, &nSrcX, &nSrcY);
	...
	lea	eax, DWORD PTR _nSrcY$92045[esp+12]
	lea	ecx, DWORD PTR _nSrcX$92044[esp+12]
	push	eax
...
; 437  : 			g_ScenePlace.MoveObject(CGOG_MISSLE, m_nMissleId, nSrcX, nSrcY, m_nCurrentMapZ, m_SceneID, IPOT_RL_OBJECT | IPOT_RL_LIGHT_PROP );
	...
	mov	eax, DWORD PTR _nSrcY$92045[esp+12]
	lea	ecx, DWORD PTR [esi+2932]
	push	10					; 0000000aH
	push	ecx
	mov	ecx, DWORD PTR _nSrcX$92044[esp+20]
	push	edx
...
; 439  : 			g_ScenePlace.MoveObject(CGOG_MISSLE, m_nMissleId, nSrcX, nSrcY, m_nCurrentMapZ, m_SceneID, IPOT_RL_OBJECT);
	...
	mov	edx, DWORD PTR _nSrcY$92045[esp+12]
	lea	eax, DWORD PTR [esi+2932]
	push	2
	push	eax
	mov	eax, DWORD PTR _nSrcX$92044[esp+20]
	push	ecx
	mov	ecx, DWORD PTR [esi+356]
	push	edx
	push	eax
...
; 519  : 			nNpcIdx = SubWorld[m_nSubWorldId].m_Region[nColRegion].FindNpc(nColMapX, nColMapY, m_nLauncher, m_eRelation);
	...
	mov	DWORD PTR $T92974[esp+48], edx
...
$L92960:
	...
	jne	SHORT $L92963
	push	eax
	mov	eax, DWORD PTR $T92974[esp+52]
	push	eax
...
; 534  : 		for (int i = -m_nCollideRange; i <= m_nCollideRange; i ++)
	...
	neg	ebx
	cmp	ebx, eax
	mov	DWORD PTR _i$92085[esp+48], ebx
	jg	SHORT $L92088
$L92086:
...
; 535  : 			for (int j = -m_nCollideRange; j <= m_nCollideRange; j ++)
	...
	neg	esi
	cmp	esi, eax
	mov	DWORD PTR _j$92089[esp+48], esi
	jg	$L92087
$L92090:
...
; 541  : 				nNpcIdx = SubWorld[m_nSubWorldId].m_Region[nSearchRegion].FindNpc(nRMx, nRMy, m_nLauncher, m_eRelation);
	...
	mov	ecx, DWORD PTR [edi+332]
	mov	DWORD PTR $T93013[esp+48], eax
	mov	eax, DWORD PTR [edi+360]
	mov	DWORD PTR $T93012[esp+48], ecx
	mov	ecx, DWORD PTR _nRMy$[esp+48]
	lea	esi, DWORD PTR [eax+eax*4]
	mov	edx, DWORD PTR _nRMx$[esp+48]
	mov	DWORD PTR $T93011[esp+48], ecx
	mov	ebp, edx
	...
	test	esi, esi
	je	SHORT $L93025
	mov	ebx, DWORD PTR $T93013[esp+48]
$L92996:
	mov	eax, DWORD PTR [esi+12]
	lea	edx, DWORD PTR [eax+eax*4]
	shl	edx, 4
	...
	cmp	DWORD PTR ?Npc@@3PAVKNpc@@A[ecx+2756], ebp
	jne	SHORT $L92999
	mov	edx, DWORD PTR $T93011[esp+48]
	cmp	DWORD PTR ?Npc@@3PAVKNpc@@A[ecx+2760], edx
	jne	SHORT $L92999
	push	eax
	mov	eax, DWORD PTR $T93012[esp+52]
	push	eax
	mov	ecx, OFFSET FLAT:?NpcSet@@3VKNpcSet@@A
	call	?GetRelation@KNpcSet@@QAE?AW4NPC_RELATION@@HH@Z ; KNpcSet::GetRelation
	test	eax, ebx
...
$L93019:
	...
	jg	SHORT $L92082
$L93025:
	mov	esi, DWORD PTR _j$92089[esp+48]
	mov	ebx, DWORD PTR _i$92085[esp+48]
$L92091:
	mov	eax, DWORD PTR [edi+144]
	inc	esi
	cmp	esi, eax
...
; 568  : 			Npc[m_nLauncher].GetMpsPos(&nPX, &nPY);
	...
	lea	eax, DWORD PTR _nPY$92105[esp+24]
	lea	ecx, DWORD PTR _nPX$92104[esp+24]
	push	eax
	mov	eax, DWORD PTR [esi+332]
	push	ecx
	lea	edx, DWORD PTR [eax+eax*4]
...
; 569  : 			if (nPX != m_nLauncherSrcPX || nPY != m_nLauncherSrcPY)
	...
	mov	eax, DWORD PTR _nPX$92104[esp+24]
	mov	ecx, DWORD PTR [esi+136]
	cmp	eax, ecx
	jne	SHORT $L92107
	mov	ecx, DWORD PTR _nPY$92105[esp+24]
...
; 575  : 				SubWorld[0].Map2Mps(m_nRegionId, m_nCurrentMapX, m_nCurrentMapY,m_nXOffset, m_nYOffset, &nSrcX2, &nSrcY2);
	...
	mov	ecx, DWORD PTR [esi+232]
	lea	edx, DWORD PTR _nSrcY2$92109[esp+24]
	lea	eax, DWORD PTR _nSrcX2$92108[esp+24]
	push	edx
	mov	edx, DWORD PTR [esi+228]
	push	eax
	mov	eax, DWORD PTR [esi+220]
	...
	push	edx
	mov	ecx, OFFSET FLAT:?SubWorld@@3PAVKSubWorld@@A
	mov	DWORD PTR _nSrcX2$92108[esp+52], ebp
	mov	DWORD PTR _nSrcY2$92109[esp+52], ebp
	call	?Map2Mps@KSubWorld@@QAEXHHHHHPAH0@Z	; KSubWorld::Map2Mps

; 576  : 				CreateSpecialEffect(MS_DoVanish, nSrcX2, nSrcY2, m_nCurrentMapZ);

	mov	eax, DWORD PTR [esi+224]
	mov	ecx, DWORD PTR _nSrcY2$92109[esp+24]
	mov	edx, DWORD PTR _nSrcX2$92108[esp+24]
	push	ebp
	push	eax
	push	ecx
	push	edx
...
; 591  : 		SubWorld[0].Map2Mps(m_nRegionId, m_nCurrentMapX, m_nCurrentMapY,m_nXOffset, m_nYOffset, &nSrcX3, &nSrcY3);
	...
	mov	eax, DWORD PTR [esi+232]
	lea	ecx, DWORD PTR _nSrcY3$92112[esp+24]
	lea	edx, DWORD PTR _nSrcX3$92111[esp+24]
	push	ecx
	mov	ecx, DWORD PTR [esi+228]
	push	edx
	mov	edx, DWORD PTR [esi+220]
	...
	push	ecx
	mov	ecx, OFFSET FLAT:?SubWorld@@3PAVKSubWorld@@A
	mov	DWORD PTR _nSrcX3$92111[esp+52], ebp
	mov	DWORD PTR _nSrcY3$92112[esp+52], ebp
	call	?Map2Mps@KSubWorld@@QAEXHHHHHPAH0@Z	; KSubWorld::Map2Mps

; 592  : 		CreateSpecialEffect(MS_DoVanish, nSrcX3, nSrcY3, m_nCurrentMapZ);

	mov	edx, DWORD PTR [esi+224]
	mov	eax, DWORD PTR _nSrcY3$92112[esp+24]
	mov	ecx, DWORD PTR _nSrcX3$92111[esp+24]
	push	ebp
	push	edx
	push	eax
	push	ecx
...
; 603  : 	{
	...
	ja	$L92171
	xor	ecx, ecx
	mov	cl, BYTE PTR $L93118[eax]
	jmp	DWORD PTR $L93119[ecx*4]
$L92121:
...
; 649  : 			int dy = (m_nSpeed + 50)  * (g_DirSin(m_nAngle,MaxMissleDir) - g_DirSin(nPreAngle, MaxMissleDir)) ; 
	...
	test	ebx, ebx
	mov	DWORD PTR _dx$92130[esp+32], ecx
	jl	SHORT $L93065
	cmp	ebx, 64					; 00000040H
	jge	SHORT $L93065
	mov	eax, ebx
...
; 676  : 			if (m_nParam1)
	...
	mov	edi, DWORD PTR _dx$92130[esp+32]
	test	eax, eax
	je	SHORT $L92150
$L93116:
...
; 705  : 			int dy = (m_nSpeed + m_nCurrentLife + 50)  * (g_DirSin(m_nAngle,MaxMissleDir) - g_DirSin(nPreAngle,MaxMissleDir)) ; 
	...
	test	edi, edi
	mov	DWORD PTR _dx$92144[esp+32], ecx
	jl	SHORT $L93095
	cmp	edi, 64					; 00000040H
	jge	SHORT $L93095
	mov	eax, edi
...
; 731  : 			if (m_nParam1)
	...
	mov	eax, DWORD PTR [esi+392]
	mov	edi, DWORD PTR _dx$92144[esp+32]
	test	eax, eax
	je	$L92150
...
; 753  : 			SubWorld[m_nSubWorldId].Map2Mps(m_nRegionId, m_nCurrentMapX, m_nCurrentMapY, m_nXOffset, m_nYOffset, &nSrcMpsX, &nSrcMpsY);
	...
	mov	eax, DWORD PTR [esi+232]
	lea	ecx, DWORD PTR _nSrcMpsY$92157[esp+32]
	lea	edx, DWORD PTR _nSrcMpsX$92156[esp+32]
	push	ecx
	mov	ecx, DWORD PTR [esi+228]
	push	edx
	mov	edx, DWORD PTR [esi+220]
	...
	mov	ecx, DWORD PTR [esi+364]
	push	ecx
	mov	DWORD PTR _nSrcMpsX$92156[esp+60], ebp
	lea	edx, DWORD PTR [eax+eax*4]
	mov	DWORD PTR _nSrcMpsY$92157[esp+60], ebp
	mov	DWORD PTR _nDesMpsX$92158[esp+60], ebp
	mov	DWORD PTR _nDesMpsY$92159[esp+60], ebp
	lea	eax, DWORD PTR [eax+edx*2]
	lea	eax, DWORD PTR [eax+eax*4]
	lea	ecx, DWORD PTR ?SubWorld@@3PAVKSubWorld@@A[eax*4]
	call	?Map2Mps@KSubWorld@@QAEXHHHHHPAH0@Z	; KSubWorld::Map2Mps
...
; 754  : 			SubWorld[m_nSubWorldId].Map2Mps(Npc[m_nFollowNpcIdx].m_RegionIndex, Npc[m_nFollowNpcIdx].m_MapX, Npc[m_nFollowNpcIdx].m_MapY, Npc[m_nFollowNpcIdx].m_OffX, Npc[m_nFollowNpcIdx].m_OffY, &nDesMpsX, &nDesMpsY);
	...
	mov	eax, DWORD PTR [esi+324]
	lea	edx, DWORD PTR _nDesMpsY$92159[esp+32]
	push	edx
	lea	ecx, DWORD PTR [eax+eax*4]
	shl	ecx, 4
	sub	ecx, eax
	lea	eax, DWORD PTR [eax+ecx*4]
	lea	ecx, DWORD PTR _nDesMpsX$92158[esp+36]
	push	ecx
	lea	eax, DWORD PTR [eax+eax*2]
	shl	eax, 5
...
; 755  : 			nDistance = SubWorld[m_nSubWorldId].GetDistance(nSrcMpsX, nSrcMpsY, nDesMpsX, nDesMpsY);
	...
	mov	eax, DWORD PTR _nDesMpsY$92159[esp+32]
	mov	ecx, DWORD PTR _nDesMpsX$92158[esp+32]
	mov	edx, DWORD PTR _nSrcMpsY$92157[esp+32]
	push	eax
	mov	eax, DWORD PTR _nSrcMpsX$92156[esp+36]
	push	ecx
	push	edx
	push	eax
	mov	eax, DWORD PTR [esi+360]
...
; 763  : 				nDOffsetX	 = dx;
	...
	mov	eax, DWORD PTR _nDesMpsX$92158[esp+32]
	mov	ebx, DWORD PTR _nSrcMpsY$92157[esp+32]
	sub	eax, ebx
...
; 807  : 			SubWorld[0].Map2Mps(m_nRegionId, m_nCurrentMapX, m_nCurrentMapY,m_nXOffset, m_nYOffset, &nSrcX4, &nSrcY4);
	...
	mov	edx, DWORD PTR [esi+232]
	lea	eax, DWORD PTR _nSrcY4$92177[esp+24]
	lea	ecx, DWORD PTR _nSrcX4$92176[esp+24]
	push	eax
	mov	eax, DWORD PTR [esi+228]
	push	ecx
	mov	ecx, DWORD PTR [esi+220]
	...
	push	eax
	mov	ecx, OFFSET FLAT:?SubWorld@@3PAVKSubWorld@@A
	mov	DWORD PTR _nSrcX4$92176[esp+52], ebp
	mov	DWORD PTR _nSrcY4$92177[esp+52], ebp
	call	?Map2Mps@KSubWorld@@QAEXHHHHHPAH0@Z	; KSubWorld::Map2Mps

; 808  : 			CreateSpecialEffect(MS_DoVanish, nSrcX4, nSrcY4, m_nCurrentMapZ);

	mov	ecx, DWORD PTR [esi+224]
	mov	edx, DWORD PTR _nSrcY4$92177[esp+24]
	mov	eax, DWORD PTR _nSrcX4$92176[esp+24]
	push	ebp
	push	ecx
	push	edx
	push	eax
...
; 1135 : 		SubWorld[0].Map2Mps(m_nRegionId, m_nCurrentMapX, m_nCurrentMapY,m_nXOffset, m_nYOffset, &nSrcX5, &nSrcY5);
	...
	mov	edx, DWORD PTR [esi+232]
	lea	eax, DWORD PTR _nSrcY5$92270[esp+24]
	lea	ecx, DWORD PTR _nSrcX5$92269[esp+24]
	push	eax
	mov	eax, DWORD PTR [esi+228]
	push	ecx
	mov	ecx, DWORD PTR [esi+220]
	...
	mov	ecx, OFFSET FLAT:?SubWorld@@3PAVKSubWorld@@A
	mov	DWORD PTR [esi+488], 1
	mov	DWORD PTR _nSrcX5$92269[esp+52], edi
	mov	DWORD PTR _nSrcY5$92270[esp+52], edi
	call	?Map2Mps@KSubWorld@@QAEXHHHHHPAH0@Z	; KSubWorld::Map2Mps

; 1136 : 		CreateSpecialEffect(MS_DoVanish, nSrcX5, nSrcY5, m_nCurrentMapZ);

	mov	ecx, DWORD PTR [esi+224]
	mov	edx, DWORD PTR _nSrcY5$92270[esp+24]
	mov	eax, DWORD PTR _nSrcX5$92269[esp+24]
	push	edi
	push	ecx
	push	edx
	push	eax
...
; 1253 : 		for (int j = -nRangeY; j <= nRangeY; j++)
	...
	cmp	eax, edx
	mov	DWORD PTR _j$92323[esp+56], eax
	jg	$L92321
	jmp	SHORT $L92324
$L93340:
...
; 1272 : 				SubWorld[0].Map2Mps(nSearchRegion, Npc[nNpcIdx].m_MapX,Npc[nNpcIdx].m_MapY, Npc[nNpcIdx].m_OffX, Npc[nNpcIdx].m_OffY,  &nSrcX, &nSrcY);
	...
	lea	ecx, DWORD PTR _nSrcY$92332[esp+52]
	inc	edx
	push	ecx
	...
	sub	edx, esi
	xor	edi, edi
	mov	DWORD PTR _nSrcX$92331[esp+60], edi
	mov	DWORD PTR _nSrcY$92332[esp+56], edi
	lea	eax, DWORD PTR [esi+edx*4]
	lea	edx, DWORD PTR _nSrcX$92331[esp+60]
	push	edx
	lea	eax, DWORD PTR [eax+eax*2]
	shl	eax, 5
...
; 1275 : 					CreateSpecialEffect(MS_DoCollision, nSrcX, nSrcY, m_nCurrentMapZ, nNpcIdx);
	...
	mov	eax, DWORD PTR _nSrcY$92332[esp+52]
	push	esi
	push	edx
	mov	edx, DWORD PTR _nSrcX$92331[esp+64]
	push	eax
	push	edx
...
; 1277 : 					CreateSpecialEffect(MS_DoCollision, nSrcX, nSrcY, m_nCurrentMapZ);
	...
	mov	edx, DWORD PTR _nSrcY$92332[esp+52]
	push	edi
	push	eax
	mov	eax, DWORD PTR _nSrcX$92331[esp+64]
	push	edx
	push	eax
$L93341:
	push	3
	call	?CreateSpecialEffect@KMissle@@QAEHW4eMissleStatus@@HHHH@Z ; KMissle::CreateSpecialEffect
$L92325:
	mov	eax, DWORD PTR _j$92323[esp+56]
...
;	COMDAT xdata$x
xdata$x	SEGMENT
$T93410	DD	019930520H
	DD	01H
	DD	FLAT:$T93415
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	ORG $+4
$T93415	DD	0ffffffffH
	DD	FLAT:$L93357
xdata$x	ENDS
;	COMDAT ?CreateSpecialEffect@KMissle@@QAEHW4eMissleStatus@@HHHH@Z
_TEXT	SEGMENT
...
; 1317 : 	KSkillSpecial * pSkillSpecial = new KSkillSpecial;
	...
	call	??2@YAPAXI@Z				; operator new
	add	esp, 4
	mov	DWORD PTR $T93353[esp+28], eax
	xor	ecx, ecx
	cmp	eax, ecx
...
text$x	SEGMENT
$L93357:
	mov	eax, DWORD PTR $T93353[ebp-4]
	push	eax
	call	??3@YAXPAX@Z				; operator delete
	pop	ecx
	ret	0
$L93414:
	mov	eax, OFFSET FLAT:$T93410
	jmp	___CxxFrameHandler
text$x	ENDS
...
; 1432 : 		Npc[m_nLauncher].GetMpsPos(&nPX, &nPY);
	...
	lea	eax, DWORD PTR _nPY$92404[esp+32]
	lea	ecx, DWORD PTR _nPX$92403[esp+32]
	push	eax
	mov	eax, DWORD PTR [esi+332]
	push	ecx
	lea	edx, DWORD PTR [eax+eax*4]
...
; 1433 : 		if (nPX != m_nLauncherSrcPX || nPY != m_nLauncherSrcPY)
	...
	mov	eax, DWORD PTR _nPX$92403[esp+32]
	mov	ecx, DWORD PTR [esi+136]
	cmp	eax, ecx
	jne	SHORT $L92406
	mov	ecx, DWORD PTR _nPY$92404[esp+32]
	mov	eax, DWORD PTR [esi+140]
	cmp	ecx, eax
	je	SHORT $L92405
$L92406:
...
; 1455 : 				Missle[m_nParentMissleIndex].GetMpsPos(&nParentPX, &nParentPY);
	...
	lea	ecx, DWORD PTR _nParentPY$92414[esp+32]
	lea	edx, DWORD PTR _nParentPX$92413[esp+32]
	push	ecx
	push	edx
...
; 1456 : 				GetMpsPos(&nSrcPX, &nSrcPY);
	...
	lea	eax, DWORD PTR _nSrcPY$92416[esp+32]
	lea	ecx, DWORD PTR _nSrcPX$92415[esp+32]
	push	eax
	push	ecx
	mov	ecx, esi
	call	?GetMpsPos@KMissle@@QAEXPAH0@Z		; KMissle::GetMpsPos
...
; 1457 : 				nNewPX = nSrcPX + (nParentPX - m_nRefPX);
	...
	mov	ebx, DWORD PTR _nSrcPX$92415[esp+32]
	mov	edi, DWORD PTR [esi+236]
	mov	edx, DWORD PTR _nParentPX$92413[esp+32]

; 1458 : 				nNewPY = nSrcPY + (nParentPY - m_nRefPY);

	mov	ebp, DWORD PTR _nSrcPY$92416[esp+32]
	mov	ecx, DWORD PTR [esi+240]
	mov	eax, DWORD PTR _nParentPY$92414[esp+32]
	sub	ebx, edi
	add	ebx, edx
	sub	ebp, ecx
...
; 1468 : 			Npc[m_nLauncher].GetMpsPos(&nParentPX, &nParentPY);
	...
	lea	edx, DWORD PTR _nParentPY$92420[esp+32]
	lea	eax, DWORD PTR _nParentPX$92419[esp+32]
	push	edx
	push	eax
	mov	eax, DWORD PTR [esi+332]
	lea	ecx, DWORD PTR [eax+eax*4]
...
; 1469 : 			GetMpsPos(&nSrcPX, &nSrcPY);
	...
	lea	edx, DWORD PTR _nSrcPY$92422[esp+32]
	lea	eax, DWORD PTR _nSrcPX$92421[esp+32]
	push	edx
	push	eax
	mov	ecx, esi
	call	?GetMpsPos@KMissle@@QAEXPAH0@Z		; KMissle::GetMpsPos
...
; 1471 : 			nNewPX = nSrcPX + (nParentPX - m_nRefPX);
	...
	mov	ebx, DWORD PTR _nSrcPX$92421[esp+32]
	mov	edi, DWORD PTR [esi+236]
	mov	edx, DWORD PTR _nParentPX$92419[esp+32]

; 1472 : 			nNewPY = nSrcPY + (nParentPY - m_nRefPY);

	mov	ebp, DWORD PTR _nSrcPY$92422[esp+32]
	mov	ecx, DWORD PTR [esi+240]
	mov	eax, DWORD PTR _nParentPY$92420[esp+32]
	sub	ebx, edi
	add	ebx, edx
	sub	ebp, ecx
$L93463:
...
; 1476 : 		CurRegion.DecRef(m_nCurrentMapX, m_nCurrentMapY, obj_missle);
	...
	mov	ecx, DWORD PTR [esi+360]
	mov	DWORD PTR _nOldRegion$92423[esp+40], eax
	push	edx
	lea	edx, DWORD PTR [ecx+ecx*4]
	imul	eax, 208				; 000000d0H
	lea	ecx, DWORD PTR [ecx+edx*2]
...
; 1480 : 		if (nOldRegion != m_nRegionId)
	...
	mov	eax, DWORD PTR _nOldRegion$92423[esp+32]
	cmp	eax, edi
	je	SHORT $L92424
...
; 1509 : 		for (int j = -1; j <= 1; j ++)
	...
	or	eax, -1
	mov	DWORD PTR _j$92446[esp+56], eax
$L92447:
...
; 1526 : 			nNpcIdx = SubWorld[m_nSubWorldId].m_Region[nSearchRegion].FindNpc(nRMx, nRMy, m_nLauncher, m_eRelation);
	...
	mov	eax, DWORD PTR [esi+332]
	mov	ecx, DWORD PTR _nRMy$[esp+56]
	mov	DWORD PTR $T93503[esp+56], eax
	mov	eax, DWORD PTR [esi+360]
	mov	edx, DWORD PTR [esi+108]
	mov	DWORD PTR $T93502[esp+56], ecx
	lea	edi, DWORD PTR [eax+eax*4]
	mov	DWORD PTR $T93504[esp+56], edx
	mov	edx, DWORD PTR _nRMx$[esp+56]
	lea	eax, DWORD PTR [eax+edi*2]
	mov	ebx, edx
	lea	edi, DWORD PTR [eax+eax*4]
	...
	test	edi, edi
	je	$L92448
	mov	ebp, DWORD PTR $T93504[esp+56]
$L93496:
	...
	jne	SHORT $L93499
	mov	edx, DWORD PTR $T93502[esp+56]
	cmp	DWORD PTR ?Npc@@3PAVKNpc@@A[ecx+2760], edx
	jne	SHORT $L93499
	push	eax
	mov	eax, DWORD PTR $T93503[esp+60]
	push	eax
	mov	ecx, OFFSET FLAT:?NpcSet@@3VKNpcSet@@A
	call	?GetRelation@KNpcSet@@QAE?AW4NPC_RELATION@@HH@Z ; KNpcSet::GetRelation
	test	eax, ebp
...
; 1509 : 		for (int j = -1; j <= 1; j ++)
	...
	mov	eax, DWORD PTR _j$92446[esp+56]
	inc	eax
	cmp	eax, 1
	mov	DWORD PTR _j$92446[esp+56], eax
	jle	$L92447
