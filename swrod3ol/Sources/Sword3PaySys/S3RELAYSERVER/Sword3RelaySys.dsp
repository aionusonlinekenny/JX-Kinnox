...
# ADD CPP /nologo /MD /W3 /GR /GX /O2 /I "..\regexp" /I "..\mysql++-1.7.1-1-win32-vc++\include" /I "..\mysql\include" /I "..\\" /I "d:\dx81sdk\include" /I "..\Toolkits\mysql++-1.7.1-1-win32-vc++\include" /I "..\Toolkits\mysql\include" /I "..\..\..\Headers" /D "WIN32" /D "NDEBUG" /D "_CONSOLE" /D "_MBCS" /YX /FD /c
...
# ADD LINK32 Ws2_32.lib Winmm.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:console /debug /machine:I386 /nodefaultlib:"LIBCD.lib" /out:"../../../../bin/client/Sword3RelaySys.exe" /pdbtype:sept
